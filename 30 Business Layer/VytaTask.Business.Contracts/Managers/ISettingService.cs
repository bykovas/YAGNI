...
namespace VytaTask.Business.Contracts.Managers
{
    ...
    public interface ISettingService
    {
        ...
        ISetting GetSettingById(int settingId);

        /// <summary>
        /// Deletes a setting
        /// </summary>
        /// <param name="setting">Setting</param>
        void DeleteSetting(ISetting setting);

        /// <summary>
        /// Deletes settings
        /// </summary>
        /// <param name="settings">Settings</param>
        void DeleteSettings(IList<ISetting> settings);
        ...
        /// <returns>Setting</returns>
        ISetting GetSetting(string key, int regionId = 0, bool loadSharedValueIfNotFound = false);
        ...
        void SetSetting<T>(string key, T value, int regionId = 0, bool clearCache = true);

        /// <summary>
        /// Gets all settings
        /// </summary>
        /// <returns>Settings</returns>
        IList<ISetting> GetAllSettings();
        ...
        T LoadSetting<T>(int regionId = 0) where T : ISettings, new();
        ...
        void SaveSetting<T>(T settings, int regionId = 0) where T : ISettings, new();
        ...
        /// <summary>
        /// Save settings object (per region). If the setting is not overridden per regionm then it'll be delete
        /// </summary>
        /// <typeparam name="T">Entity type</typeparam>
        /// <typeparam name="TPropType">Property type</typeparam>
        /// <param name="settings">Settings</param>
        ...
        /// <param name="regionId">Region ID</param>
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        void SaveSettingOverridablePerRegion<T, TPropType>(T settings,
            Expression<Func<T, TPropType>> keySelector,
