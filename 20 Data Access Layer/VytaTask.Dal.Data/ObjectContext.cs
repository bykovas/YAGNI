...
using VytaTask.Dal.Data.Mappings;

namespace VytaTask.Dal.Data
{
    class EfObjectContext : DbContext, IDbContext
    {
        #region Ctor
        ...
        /// <typeparam name="T">Base entity Id type</typeparam>
        /// <param name="entity">Entity</param>
        /// <returns>Attached entity</returns>
        protected virtual TEntity AttachEntityToContext<TEntity, T>(TEntity entity) where TEntity : BaseEntity<T>, new()
        {
        ...
        public new IDbSet<TEntity> Set<TEntity, T>() where TEntity : BaseEntity<T>
        {
        ...
        public IList<TEntity> ExecuteStoredProcedureList<TEntity, T>(string commandText, params object[] parameters) where TEntity : BaseEntity<T>, new()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < result.Count; i++)
                    result[i] = AttachEntityToContext<TEntity, T>(result[i]);
            }
            finally
            {
