...
namespace VytaTask.CrossCutting.Infrastructure
{
    ...
    public partial class CommonHelper
    {
        ...
        public static TypeConverter GetMrCustomTypeConverter(Type type)
        {
        ...
        public static object To(object value, Type destinationType, CultureInfo culture)
        {
            if (value != null)
            {
                ...
                TypeConverter destinationConverter = GetMrCustomTypeConverter(destinationType);
                TypeConverter sourceConverter = GetMrCustomTypeConverter(sourceType);
