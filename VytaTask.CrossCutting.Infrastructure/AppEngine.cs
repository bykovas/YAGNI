...
namespace VytaTask.CrossCutting.Infrastructure
{
    public class AppEngine : IEngine
    {
        ...
        protected virtual void RegisterDependencies(VytaTaskConfig config)
        {
            ...
            builder.RegisterInstance(config).As<VytaTaskConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(VytaTaskConfig config)
        {
            ////dependencies
            //var typeFinder = new WebAppTypeFinder();
        ...
        /// <summary>
        /// Initialize components and plugins in the mr environment.
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(VytaTaskConfig config)
        {
            //register dependencies
            ...
            //initialise and start ServiceBroker event messages queue handling (service broker stuff, listener, etc..)
